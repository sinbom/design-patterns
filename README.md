...
- ## Structural Patterns(구조 관련 패턴)
    ...
    - [Flyweight(플라이웨이트 패턴)](https://github.com/sinbom/design-patterns/blob/master/structural-patterns/flyweight.md)
    - [Proxy(프록시 패턴)](https://github.com/sinbom/design-patterns/blob/master/structural-patterns/proxy.md)
